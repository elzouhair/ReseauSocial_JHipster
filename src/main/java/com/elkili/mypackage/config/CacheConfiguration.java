package com.elkili.mypackage.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.elkili.mypackage.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.elkili.mypackage.repository.UserRepository.USERS_BY_EMAIL_CACHE);
