...
import { ProfComponent } from 'app/entities/prof/prof.component';
import { ProfService } from 'app/entities/prof/prof.service';
import { Prof } from 'app/shared/model/prof.model';

describe('Component Tests', () => {
  describe('Prof Management Component', () => {
    let comp: ProfComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProfComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.profs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
